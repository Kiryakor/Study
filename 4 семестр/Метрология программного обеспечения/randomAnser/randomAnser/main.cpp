...
string const Href = "/Users/kirill/Desktop/randomAnser/randomAnser/file.txt";
...
void RandomAnser::addAnser(){
    ...
    if (check){
        ...
        getline(cin, newElemet.auther);
        cout << "Введите категорию" << endl;
        getline(cin, newElemet.category);
